...
<body>
    ...
    <div class="content-wrapper">
        <div class="container py-4">
            ...
            <?php if ($message): ?>
                <div class="alert bg-success-soft text-success border-0 small py-3 mb-5 fw-bold text-center"><?php echo htmlspecialchars($message); ?></div>
            <?php endif; ?>
                            ...
                            <div class="row align-items-start gx-5">
                                <div class="col-md-4">
                                    <div class="flat-header">
                                        ...
                                        <p class="fw-bold text-dark mt-2"><?php echo htmlspecialchars(($f['first_name'] ? $f['first_name'] . ' ' . $f['last_name'] : 'Faculty Member')); ?></p>
