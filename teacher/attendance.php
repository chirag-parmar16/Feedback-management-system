...
// Step 1: Fetch assigned classes and subjects — prepared statement
...
if (isset($_GET['assignment_id'])) {
    ...
    if (count($parts) == 2 && is_numeric($parts[0]) && is_numeric($parts[1])) {
        ...
        // Validate this assignment belongs to this teacher
        ...
        if ($valid->get_result()->fetch_assoc()['cnt'] > 0) {
            // Fetch students — prepared statement
            $stmt2 = $conn->prepare("SELECT u.id, u.username, p.first_name, p.last_name, p.Enroll_No 
                                      FROM users u 
        ...
        <div class="container py-4">
            ...
            <?php elseif (isset($_GET['assignment_id'])): ?>
                <div class="premium-panel text-center py-5">
                    ...
                    <a href="teacher_dashboard.php" class="btn btn-light border px-4 small fw-bold">Return to Overview</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
